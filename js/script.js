...
function initRatings() {
   ...
   function initRating(rating) {
      ...
      if(rating.hasAttribute('data-rating-set')) {
         setRating(rating)
         rating.classList.add('-rating-set')
      }
   }

   function initRatingVars(rating) {
      ratingActive = rating.querySelector('[data-rating-active]')
      ratingValue = rating.querySelector('[data-rating-label]')
   }
   ...
   function setRating(rating) {
      const ratingsItems = rating.querySelectorAll('[data-rating-input]')
